...
{
    public partial class Garndatum
    {
        public Garndatum()
        {
            InverseParentNavigation = new HashSet<Garndatum>();
        }
        ...
        public string? ДиспетчерПсг { get; set; }
        ...
        public virtual Garndatum? ParentNavigation { get; set; }
        public virtual ICollection<Garndatum> InverseParentNavigation { get; set; }
    }
}
