...
{
    public partial class ApivotMat
    {
        ...
        public long? ПоСписку { get; set; }
        public decimal? Налицо { get; set; }
        public decimal? Всего { get; set; }
        public long? Резерв { get; set; }
        public long? Нк { get; set; }
        public long? Диспетчер { get; set; }
        public long? Пнк { get; set; }
        public long? Ко { get; set; }
        public long? Водитель { get; set; }
        public long? Пожарный { get; set; }
        public decimal? Гдзс { get; set; }
        public decimal? ВсегоОтс { get; set; }
        public long? Отпуск { get; set; }
        public long? ПоБольничному { get; set; }
        public long? Командировка { get; set; }
        public long? Некомплект { get; set; }
